...
model = YOLO("weights/best.pt")  # Corrected initialization
...
def paddle_ocr(frame, x1, y1, x2, y2):
    # Code for PaddleOCR remains unchanged
...
def save_json(license_plates, startTime, endTime):
    # JSON and database handling remains unchanged
    interval_data = {
...
def save_to_database(license_plates, start_time, end_time):
    # Database handling remains unchanged
...
while True:
    ...
    if ret:
        ...
        results = model(frame, conf=0.45)  # Corrected method for predictions
